...
tasks.jar {
    manifest {
        ...
        attributes(
            ...
            "Implementation-Title" to "Terrain",
            "Implementation-Version" to implementationVersion,
            "Implementation-Vendor" to date,
            "Specification-Title" to "Terrain",
            "Specification-Version" to project.version,
            "Specification-Vendor" to "BiomeBattle Team",
            "Brand-Id" to "biomebattle:terrain",
            "Brand-Name" to "BiomeBattle",
